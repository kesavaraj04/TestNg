...
public class Base_Class {
	...
	public static  WebDriver getBrowser(String browserName) {
		try {
			if (browserName.equalsIgnoreCase("chrome")) {
				System.setProperty("webdriver.chrome.driver","C:\\Users\\kesav\\eclipse-workspace\\TestNG_Concepts\\driver\\chromedriver.exe" );
				 driver = new ChromeDriver();
				
			}else if (browserName.equalsIgnoreCase("ie")) {
				System.setProperty("webdriver.ie.driver", "C:\\Users\\kesav\\eclipse-workspace\\com.java.demo\\Driver\\IEDriverServer.exe");
				driver = new InternetExplorerDriver();
			} else {
				System.out.println("Invalid Browser : Pls choose chrome or ie");
	...
	public static void takesScreenshot() throws IOException {
		try {
			...
			File desFile = new File("C:\\Users\\kesav\\eclipse-workspace\\Automation\\ScreenShot\\name\\png");
			FileUtils.copyToDirectory(srcFile, desFile);
